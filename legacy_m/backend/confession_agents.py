...
**КРИТИЧЕСКОЕ НАПОМИНАНИЕ**: Если ты не можешь дать точную ссылку на источник — используй общие формулировки и ставь маркер [ТРЕБУЕТ ВЕРИФИКАЦИИ]. Честность в признании границ знания — часть исламской этики."""
    ...
    def _calculate_similarity_score(self, question: str, text: str) -> float:
        ...
        # РАДИКАЛЬНО РАСШИРЕННЫЙ список важных слов с синонимами
        important_words = {
            'бог': ['бог', 'аллах', 'господь', 'творец', 'создатель', 'всевышний', 'всемогущий'],
            'молитва': ['молитва', 'намаз', 'дуа', 'поклонение', 'богослужение', 'молиться', 'молись'],
            'вера': ['вера', 'иман', 'убеждение', 'религия', 'веровать', 'верующий'],
            'ислам': ['ислам', 'мусульманство', 'мусульманин', 'мусульманка', 'мусульмане'],
            'семья': ['семья', 'семейный', 'супруг', 'супруга', 'дети', 'родители', 'жена', 'муж', 'ребенок'],
            'проблема': ['проблема', 'трудность', 'конфликт', 'спор', 'разногласие', 'сложность', 'беда'],
            'решить': ['решить', 'решение', 'уладить', 'разрешить', 'устранить', 'исправить', 'помочь'],
            'мир': ['мир', 'спокойствие', 'тишина', 'покой', 'гармония', 'мирный', 'спокойный'],
            'терпение': ['терпение', 'терпеливость', 'выносливость', 'стойкость', 'терпеть', 'терпеливый'],
            'любовь': ['любовь', 'любить', 'привязанность', 'нежность', 'любимый', 'любимая'],
            'доброта': ['доброта', 'добро', 'милосердие', 'сострадание', 'милость', 'добрый', 'милосердный'],
            'истина': ['истина', 'правда', 'истинный', 'правдивый', 'верный', 'правильный'],
            'справедливость': ['справедливость', 'справедливый', 'честность', 'честный', 'справедливо'],
            'знание': ['знание', 'знать', 'учение', 'наука', 'мудрость', 'мудрый', 'ученый'],
            'покаяние': ['покаяние', 'покаяться', 'раскаяние', 'раскаяться', 'прощение', 'простить'],
            'грех': ['грех', 'грешить', 'грешный', 'преступление', 'вина', 'виновный'],
            'рай': ['рай', 'райский', 'небеса', 'небесный', 'блаженство', 'блаженный'],
            'ад': ['ад', 'адский', 'геенна', 'муки', 'страдание', 'мучительный'],
            'пророк': ['пророк', 'посланник', 'пророчество', 'пророческий', 'мухаммад', 'иисус', 'христос'],
            'ангел': ['ангел', 'ангельский', 'небесный', 'дух', 'духовный'],
            'смерть': ['смерть', 'умереть', 'умирать', 'кончина', 'конец', 'последний'],
            'жизнь': ['жизнь', 'жить', 'живой', 'существование', 'бытие', 'существовать'],
            'душа': ['душа', 'духовный', 'дух', 'внутренний', 'сердце', 'сердечный'],
            'сердце': ['сердце', 'сердечный', 'душевный', 'внутренний', 'чувство', 'чувствовать'],
            'разум': ['разум', 'ум', 'умный', 'разумный', 'мышление', 'думать', 'мысль'],
            'чувство': ['чувство', 'чувствовать', 'эмоция', 'эмоциональный', 'переживание', 'переживать'],
            'отношение': ['отношение', 'относиться', 'связь', 'связать', 'отношения', 'взаимоотношения'],
            'православие': ['православие', 'православный', 'христианство', 'христианин', 'христианка'],
            'суннизм': ['суннизм', 'суннит', 'суннитка', 'сунниты', 'ахль ас-сунна'],
            'шиизм': ['шиизм', 'шиит', 'шиитка', 'шииты', 'ахль аль-байт', 'имамат'],
            'коран': ['коран', 'коранический', 'аят', 'сура', 'откровение', 'ниспослание'],
            'хадис': ['хадис', 'хадисов', 'предание', 'сунна', 'пророческий', 'передача'],
            'библия': ['библия', 'библейский', 'евангелие', 'евангельский', 'писание', 'священный'],
            'церковь': ['церковь', 'церковный', 'храм', 'собор', 'монастырь', 'монашество'],
            'мечеть': ['мечеть', 'мечетный', 'джума', 'пятничный', 'молитвенный', 'дом'],
            'священник': ['священник', 'священнический', 'пастырь', 'духовник', 'духовный', 'отец'],
            'имам': ['имам', 'имамат', 'имамский', 'духовный', 'руководитель', 'предводитель'],
            'мулла': ['мулла', 'мулловский', 'духовный', 'религиозный', 'служитель', 'служить']
        }
        ...
        for category, synonyms in important_words.items():
            ...
            if question_has_word and text_has_word:
                return 0.9  # МАКСИМАЛЬНАЯ релевантность для важных слов
        ...
        if question_religious and text_religious:
            base_score += 0.5  # БОЛЬШОЙ бонус за религиозную тематику
